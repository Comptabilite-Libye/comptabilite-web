...
@Component({
  selector: 'app-type-caisse',
  templateUrl: './type-caisse.component.html',
  styleUrls: ['./type-caisse.component.css', '.../../../src/assets/files/css/style.css'], providers: [ConfirmationService, MessageService]

})
export class TypeCaisseComponent {
  ...
  public onOpenModal(mode: string) {
    ...
    if (mode === 'Print') {
      ...
      this.formHeader = "Imprimer Liste TypeCaisse"
